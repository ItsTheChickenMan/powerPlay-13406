...
public class AbeConstants {
	...
	public static final double SLIDE_MAX_EXTENSION_INCHES = 36; // leaving off two inches as a just-in-case pillow...

	// wrist related... //
	public static final double WRIST_MAX_RANGE_DEGREES = 200;
	public static final double WRIST_MAX_RANGE_RADIANS = Math.toRadians(AbeConstants.WRIST_MAX_RANGE_DEGREES);

	// fingers related... //
	public static final double FINGERS_MAX_RANGE_DEGREES = 200; // FIXME: update value
