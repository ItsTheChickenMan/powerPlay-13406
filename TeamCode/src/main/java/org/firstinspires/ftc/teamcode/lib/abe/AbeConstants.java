...
public class AbeConstants {
	...
	public static final Vector2D SUBSTATION_DROP_SPOT_CENTER = new Vector2D(4, 70.75);
	public static final double SUBSTATION_DROP_SPOT_OFFSET = 8;
	...
	*/
	...
	public static final double WRIST_OFFSET_INCHES = 5.5; // how far forward the wrist hole is from the end of the slides.
